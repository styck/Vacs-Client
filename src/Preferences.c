...
//=======================================
//=======================================
BOOL APIENTRY dlgPRFGeneral(HWND hDlg, UINT message, UINT wParam, LONG lParam)
{
...
#ifdef MIDI_SUPPORT
//==================================================
BOOL APIENTRY dlgPRFMidi(HWND hDlg, UINT message, UINT wParam, LONG lParam)
{
...
//==================================================
BOOL APIENTRY dlgPRFMTC(HWND hDlg, UINT message, UINT wParam, LONG lParam)
{
...
//==================================================
BOOL APIENTRY dlgPRFActions(HWND hDlg, UINT message, UINT wParam, LONG lParam)
{
...
//==================================================
BOOL APIENTRY dlgPRFMixerChanPort(HWND hDlg, UINT message, UINT wParam, LONG lParam)
{
...
//==================================================
BOOL APIENTRY dlgPRFViews(HWND hDlg, UINT message, UINT wParam, LONG lParam)
{
