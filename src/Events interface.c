...
void    HandleRBDown(HWND hwnd, POINTS pnts, WPARAM wKeyFlags, LPMIXERWNDDATA lpmwd)
{
    POINT pnt;
...
//================================================
void HandleLBUp(HWND hwnd, POINTS pnts, WPARAM wKeyFlags, LPMIXERWNDDATA lpmwd)
{
    POINT pnt;
...
void HandleMBUp(HWND hwnd, POINTS pnts, WPARAM wKeyFlags, LPMIXERWNDDATA lpmwd)
{
    POINT pnt;
...
void HandleRBUp(HWND hwnd, POINTS pnts, WPARAM wKeyFlags, LPMIXERWNDDATA lpmwd)
{
    POINT pnt;
...
void HandleWndSize(HWND hwnd, LPMIXERWNDDATA lpmwd, WORD wWidth, WORD wHeight, WPARAM wFlags)
{
    int iCount;
    int iCX;
    int iPhisChannel;
...
void HandleFaderMoveHorz(HWND hwnd, POINT pnt, WPARAM wKeyFlags, LPMIXERWNDDATA lpmwd)
{
    ...
    // Load the Module Bitmap in the Memory DC
    //----------------------------------------
    iPhisChannel = LOBYTE(lpmwd->lpwRemapToScr[lpmwd->iCurChan + lpmwd->iStartScrChan]);
    iBMPIndex = lpmwd->lpZoneMap[iPhisChannel].iBmpIndx;
    iChanWidth = gpBMPTable[iBMPIndex].iWidth;
    iChanHeight = gpBMPTable[iBMPIndex].iHeight;
...
//=========================================
void UpdateControlsByCtrlNum(HDC hdcScreen, HDC hdcMem, LPMIXERWNDDATA lpmwd, int iXAdj, int iPhisChan,
    LPCTRLZONEMAP lpctrlZM, int iPhisVal, int iDirection, BOOL bSkipCurrent)
{
