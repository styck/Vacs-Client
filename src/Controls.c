...
//
//==================================================
void __stdcall OpenExplodeWindow(HDC hdc, LPCTRLZONEMAP lpczm, int iVal, LPMIXERWNDDATA lpmwd, int iChan)
{
    return;
}
...
// Y offset
//==================================================
void __stdcall JumpToMZWindow(HDC hdc, LPCTRLZONEMAP lpczm, int iVal, LPMIXERWNDDATA lpmwd, int iChan)
{
