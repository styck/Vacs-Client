...
LRESULT CALLBACK  WndMainProc(HWND hWnd, UINT wMessage, WPARAM wParam, LPARAM  lParam)
{
    HDC hDC;
    LPNMHDR pnotify;
    FILESTRUCT fsTemp;
...
void WriteTextToDC(HDC hdc, LPRECT rect, int iXofst, int iYofst, COLORREF clrref, LPSTR text)
{
    RECT rRect;
    int iOldBkMode;
    //HPEN    hpnOld;
...
// Write text to a DC in a specified rectangle
//============================================
void  WriteTextLinesToDC(HDC hdc, LPRECT rect, int iXofst, int iYofst, COLORREF clrref, LPSTR text)
{
    RECT rRect;
    int iOldBkMode;
    //HPEN hpnOld;
...
void WriteTextLinesToDCVerticaly(HDC hdc, LPRECT rect, int iXofst, int iYofst, COLORREF clrref, LPSTR text)
{
    RECT rRect;
    int iOldBkMode;
    //HPEN hpnOld;
...
void GetMaxWindowSize(LPRECT lpRect,LPZONE_MAP lpZM,long lZMCount,LPMIXERWNDDATA lpmwd,BOOL bScrollBars)
{
    long lCount;
    RECT rect;
