...
//fds mmResult = midiInOpen(&pMidiDev->hMidiIn, iDevId, (DWORD)Dll_MidiInProc, (DWORD)&gMidiDev, CALLBACK_FUNCTION);
...
//fds mmResult = midiOutOpen(&pMidiDev->hMidiOut, iDevId, (DWORD)Dll_MidiOutProc, (DWORD)&gMidiDev, CALLBACK_FUNCTION);
