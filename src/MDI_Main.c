...
//====================================================
void SizeClientWindow(HWND hwnd, UINT uMessage, WPARAM wparam, LPARAM lparam)
{
    RECT rcClient;
    RECT rcAdj = { 0 };
...
//====================================================
LRESULT CALLBACK MDIClientProc(HWND hWnd, UINT wMessage, WPARAM wParam, LPARAM  lParam)
{
    HWND focus_wnd;
    HWND last_wnd = -1;
