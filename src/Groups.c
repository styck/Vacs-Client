...
//
//
void UpdateGroupedControls(CONTROLDATA* pCtrlData, LPCTRLZONEMAP pctrlzm, int iDelta, LPMIXERWNDDATA lpmwd, BOOL skipSendingData)
{
    int iCount;
    int iV, val_original;
    CTRLZONEMAP ctrlZM;
...
//
//
void UpdateStereoControls(CONTROLDATA* pCtrlData, LPCTRLZONEMAP pctrlzm, int iDelta, LPMIXERWNDDATA lpmwd)
{
    CTRLZONEMAP* pctrl;
    int iV;
    int iModule;
